...
import { Search, CalendarDays, MapPin, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="pb-16">
      ...
      {isSectionVisible("banner") && (
        <div data-testid="event-banner" className="relative h-[200px] overflow-hidden md:h-[260px]">
