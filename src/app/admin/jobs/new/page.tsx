...
import { createAdminJob } from "@/lib/api";
    ...
    <div>
      <div className="mb-6">
        <div className="text-sm text-muted mb-1">
          Dashboard / Jobs / <span className="text-rose font-semibold">Add Job</span>
        </div>
        <h1 className="text-3xl font-bold">Post a New Job</h1>
        <p className="mt-1 text-muted">Create a beauty-parlour placement vacancy.</p>
      </div>
