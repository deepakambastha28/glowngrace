...
import { homeConfigSchema } from "@/lib/schemas";
...
/** GET /api/admin/home-config — current home page configuration. */
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await query(
      `INSERT INTO gg_admin_home_config (id, config, updated_at)
    ...
    console.error("PUT /api/admin/home-config failed", error);
    return NextResponse.json(
